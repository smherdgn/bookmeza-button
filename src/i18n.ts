...
// import LanguageDetector from "i18next-browser-languagedetector"; // Temporarily remove for debugging

i18n
  // .use(LanguageDetector) // Temporarily remove for debugging
  .use(initReactI18next) // Passes i18n down to react-i18next
  .init({
    debug: true, // Enable debug mode for console output
    lng: "en", // Explicitly set language for stability during debugging
